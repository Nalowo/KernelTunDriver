 ...
 *   /sys/class/net/ktunN/ktun/  queue_limit (rw), queue_len (ro), owner_pid (ro)
 *
...
static ssize_t KtunQueueLenShow(struct device *d,
				struct device_attribute *attr, char *buf)
{
	/* TODO */
	return -EOPNOTSUPP;
...
static ssize_t KtunOwnerPidShow(struct device *d,
				struct device_attribute *attr, char *buf)
{
	/* TODO */
	return -EOPNOTSUPP;
