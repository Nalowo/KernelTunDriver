...
static netdev_tx_t KtunNetStartXmit(struct sk_buff *skb, struct net_device *dev)
{
	/*
...
/* alloc_netdev() setup callback. __maybe_unused: drop once KtunNetCreate uses it. */
